...
<<<<<<< HEAD:resources/views/admin/pelanggan/edit.blade.php
...
>>>>>>> f2863a68db9bec6d2e472fc75c7316e0400934ad:resources/views/admin/warga/edit.blade.php
            </div>
        </div>
    </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="no_ktp" type="text" id="no_ktp" class="form-control"
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="agama" type="text" id="agama" class="form-control"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="telp" type="text" id="telp" class="form-control"
